...
: b2Joint(def),
m_indexA(0), m_indexB(0), m_indexC(0), m_indexD(0),
m_mA(0.0f), m_mB(0.0f), m_mC(0.0f), m_mD(0.0f),
m_iA(0.0f), m_iB(0.0f), m_iC(0.0f), m_iD(0.0f),
m_JwA(0.0f), m_JwB(0.0f), m_JwC(0.0f), m_JwD(0.0f),
m_mass(0.0f)
{
	m_joint1 = def->joint1;
	m_joint2 = def->joint2;
	...
	b2Assert(m_typeA == b2JointType::e_revoluteJoint || m_typeA == b2JointType::e_prismaticJoint);
	b2Assert(m_typeB == b2JointType::e_revoluteJoint || m_typeB == b2JointType::e_prismaticJoint);
