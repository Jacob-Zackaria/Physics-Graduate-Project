...
protected:
	...
	b2Contact() :
		...
		m_indexA(0), m_indexB(0),
		m_manifold{},
		m_toiCount(0), m_toi(0.0f),
		m_friction(0.0f), m_restitution(0.0f), m_tangentSpeed(0.0f)
	{}
	...
	static b2ContactRegister s_registers[(unsigned int)b2Shape::Type::e_typeCount][(unsigned int)b2Shape::Type::e_typeCount];
